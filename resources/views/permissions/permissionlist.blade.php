...
<table id="table"
  ...
  <div class="card-box mb-3">
    <div class="header-bar">
        <h2> <i class="bi bi-key-fill"> Permission List</i></h2>

        <div class="d-flex gap-2">

          
            <a href="{{ route('permissions.permissioncreate') }}"
    ...
    <!-- Delete -->
    <a href="{{  route('delete',$permission->id) }}"
    ...
    <i class="bi bi-pencil-square"></i>
                ...
                <a href="{{ route('delete',$permission->id) }}" ><i class="bi bi-trash2-fill text-danger"></i></a> --}}
            </td>
        </tr>
        @endforeach
    </tbody>
